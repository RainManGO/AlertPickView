...
extension UIAlertController {
    ...
    func setTitle(font: UIFont, color: UIColor) {
        ...
        let attributes: [NSAttributedStringKey: Any] = [NSFontAttributeName as NSString: font, NSForegroundColorAttributeName as NSString: color]
        let attributedTitle = NSMutableAttributedString(string: title, attributes: attributes as [String : Any])
    ...
    func setMessage(font: UIFont, color: UIColor) {
        ...
        let attributes: [NSAttributedStringKey: Any] = [NSFontAttributeName as NSString: font, NSForegroundColorAttributeName as NSString: color]
        let attributedMessage = NSMutableAttributedString(string: message, attributes: attributes as [String : Any])
